  ...
  ngOnInit(): void {
    ...
    if (lang === 'ru') {
      ...
      this.steps = [
        ...
        { number: 2, title: "Узнай оценку справедливой стоимости с помощью других методов оценки", description: "Справедливая стоимость акции будет вычислена автоматически на основании достоверных данных." },
      ];
    } else {
