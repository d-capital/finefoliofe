...
export class ValuateComponent implements OnInit{
  ...
  growthRateCalcExplanation: string = "Темпы роста чистой прибыли (Net Income) за 1, 3, 5 лет посчтитаны по методике CAGR (Compound Annual Growth Rate)";
  growthRateCalcExplanationRu: string = "Темпы роста чистой прибыли (Net Income) за 1, 3, 5 лет посчтитаны по методике CAGR (Compound Annual Growth Rate)";
  growthRateCalcExplanationEn: string = "Net Income growth rate for 1, 3, 5 last years calulated with CAGR (Compound Annual Growth Rate)";
